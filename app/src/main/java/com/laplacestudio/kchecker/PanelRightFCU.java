...
public class PanelRightFCU extends Panel {
    ...
    private void initControls() {
        // Position params is same as controls in Left FCU
        ...
        // Reverse left of control position
        for(PanelControl control:controlList){
            control.left=panelSize.getWidth()-control.left-control.width;
        }
    }
}
